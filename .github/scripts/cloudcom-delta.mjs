...
const portalRemoteApiPaths = new Set([
  ...
  'apps/api/src/routes/portal.test.ts', 'apps/api/src/routes/portal.compat.test.ts',
...
const infraPaths = new Set([
  ...
  'scripts/release/require-upstream-intake.mjs', 'scripts/release/require-upstream-intake.test.mjs',
